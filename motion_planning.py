...
class MotionPlanning(Drone):
    ...
    def plan_path(self):
        ...
        #lato and long0 are the first line of the csv file

        with open('colliders.csv','r') as f:
            first_line = f.readline().split() 
        #print(first_line[1])---this is the lat0 coordinate
        #print(first_line[3])---this is the long 0 coordinate
        #print(first_line[1])
        #print(first_line[3])
        ...
        lat0=lat0[:-1]
        lat0=float(lat0)
        long0=float(first_line[3])
        # TODO: set home position to (lon0, lat0, 0)

        self.set_home_position(lat0,long0,0)
        
        # TODO: retrieve current global position
        cur_global_pos = self.global_position
        print("Current gkobal position is",cur_global_pos)
        ...
        target_lonlat = (-122.396261,37.795085,0.0)
